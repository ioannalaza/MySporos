		...
		<div class="header">
			<div class="collapse navbar-collapse  navbar-light text-right " style="background-color: #e6ffcc;">
				<ul class="menu-bar">
					...
					<li class="active"><a href="profileOwner_YourSporos.jsp"><span class="glyphicon glyphicon-user"></span> Profile</a></li>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-12 col-lg-6">
          <div class="about-us-thumbnail mb-100">
				<img src="images\5.jpg" class="img-rounded" style="width:450px">						
          </div>
        </div>
          ...
          <div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="100ms">
            ...
            <div class="product-desc text-center pt-4">
              <h3><%= cys.getCustomerName()%> <%= cys.getCustomerSurname()%> </h3>
							...
							<p>Διεύθυνση:<%= cys.getCustomerAddress() %></p>	
							<p><strong>Email:</strong><%= cys.getCustomerEmail() %> </p>
							<p>Επιλεγμένα m²: <%= requestRentingSpace %></p>
							<p>Μηνιαία τιμή ανά m²: <%= fys.getFieldPrice() %> &euro; </p>
							<p>Τιμή Ενοικίου: <%=requestRentingSpace * fys.getFieldPrice() %> &euro; </p>
				...
				<div class="col-12  mb-100">                 
				  ...
				  <div class="single-blog-area style-2 wow fadeInUp" data-wow-delay="300ms">
					...
					<div class="post-content text-left">
					  ...
					  <h3  class="post-title" style="color:green;"><%= cys.getCustomerName()%> <%= cys.getCustomerSurname()%></h3>
					  <div class="row justify-content-center">
					<!-- Single Benefits Area -->
					<div class="col-12 col-sm-4 col-lg">
					  <h5>Email:</h5>
						<p><%= cys.getCustomerEmail() %> </p>			  
					</div>
